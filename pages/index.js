    ...
    <Layout>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-purple-200">Connect with AI tarot readers for guidance and insight</p>
        </div>
        {trending.length > 0 && (
          <div className="bg-purple-800 bg-opacity-50 rounded-xl p-6 mb-8 border border-purple-600">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {trending.slice(0, 6).map(t => (
                <a key={t.reader_alias} href={`/reader/${t.reader_alias}`} className="bg-purple-900 bg-opacity-50 border border-purple-500 rounded-lg p-4 hover:bg-purple-700 transition">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map(cat => (
            <a key={cat.id} href={`/category/${cat.slug}`} className="block bg-gradient-to-br from-purple-800 to-indigo-800 border-2 border-purple-500 rounded-xl p-6 hover:shadow-2xl hover:scale-105 transition-all">
